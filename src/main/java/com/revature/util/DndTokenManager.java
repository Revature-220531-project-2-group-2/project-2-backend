...
@Component
public class DndTokenManager {
	
	private final Key key;
	
	private final Logger logger = LoggerFactory.getLogger(DndTokenManager.class);
	
	public DndTokenManager() {
	...
	public String issueToken(User user) {
		return Jwts.builder()
				...
				.setIssuer("Dungeon and Dragons App") 
